...
public class Catalogo extends javax.swing.JFrame {
    ...
    jPanel1Layout.setHorizontalGroup(
        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(475, 475, 475)
                .addComponent(btnPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                    javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 310,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnComprar, javax.swing.GroupLayout.PREFERRED_SIZE, 300,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnComentario, javax.swing.GroupLayout.PREFERRED_SIZE, 300,
                        javax.swing.GroupLayout.PREFERRED_SIZE))));
        ...
        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(btnVoltar, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
                            javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                        javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(tituloJogo, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20)
                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 170,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, 0)
                        .addComponent(btnComprar, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, 0)
                        .addComponent(btnComentario, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                            javax.swing.GroupLayout.PREFERRED_SIZE)))));
  ...
  private void listJogosValueChanged(javax.swing.event.ListSelectionEvent evt) {
    ...
    jogo = repo.procurar(listJogos.getSelectedValue());
    if (jogo != null) {
      tituloJogo.setText(jogo.getNome());
      descricaoJogo.setText(jogo.getDescricao());
    }
    for (Jogo jogoUser : ((UsuarioPadrao) usuario).getJogos()) {
    ...
    if (comprado) {
      ...
      btnComprar.setText("Comprar" + "(" + Double.toString(jogo.getValor()) + "C)");
  ...
  private void btnComprarMouseClicked(java.awt.event.MouseEvent evt) {
    if (listJogos.getSelectedValue() != null) {
      try {
        repoUser.debitar(usuario.getNome(), jogo.getValor());
        repoUser.creditar("ADM", jogo.getValor());
        repoUser.inserirJogo(usuario.getNome(), jogo);
        usuario = repoUser.procurar(usuario.getNome());
        btnComprar.setText("Comprado");
        btnComprar.setEnabled(false);

      } catch (SIException e) {
        btnComprar.setText("Créditos insuficientes");
      } catch (Exception e) {
        e.printStackTrace();
      }
    }
  ...
  private void btnComentarioMouseClicked(java.awt.event.MouseEvent evt) {
    if (listJogos.getSelectedValue() != null) {
      new Comentarios(jogo, usuario).setVisible(true);
      this.dispose();
    }
  }
